...
const allowedEmails = ["husain@lhmm.in", "hello@lhmm.in", "haripriya@lhmm.in", "kush@lhmm.in","arnav@lhmm.in", "fazil@lhmm.in", "chris@lhmm.in", "navya@diffrun.com", "yash@diffrun.com"];
